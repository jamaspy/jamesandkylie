        ...
        <div className="container mx-auto p-4 mb-12">
            ...
            <RoundedWrapper>
                ...
                <div className="mt-8 pl-4">
                    <p className='text-xl'><span className="font-semibold">Venue:</span> Circa 1876 Restaurant The
                        Convent</p>
                    <p className='text-xl'><span className="font-semibold">Address:</span> 64 Halls Road, Pokolbin NSW
                        2320</p>
                ...
                <div className="flex flex-col md:flex-row p-4">
                    <iframe
                        ...
                        style={{border: 0, borderRadius: '20px', boxShadow: "1px 1px 1px #F7F7F7", margin: "auto"}}
